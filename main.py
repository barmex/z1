...
import json
#Функция валидации параметра. Принимает параметр, возвращяет тип
def getType(param):
    if re.match(r"^((0[1-9]|2[0-9]|3[0-1])[.](0[1-9]|1[1-2])[.]([1-2]\d{3}))|(([1-2]\d{3})[-](0[1-9]|1[1-2])[-](0[1-9]|2[0-9]|3[0-1]))$",param): return "date"
